          ...
          <div className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="text-center p-4 rounded-lg bg-muted/20">
                ...
                <h3 className="font-medium">My Leagues</h3>
                <p className="text-sm text-muted-foreground mt-1">Manage your fantasy leagues and view recent drafts</p>
              </div>
              <div className="text-center p-4 rounded-lg bg-muted/20">
                <Trophy className="h-8 w-8 mx-auto mb-2" />
                <h3 className="font-medium">My Draft</h3>
                <p className="text-sm text-muted-foreground mt-1">Create and run real-time drafts with live sync</p>
              </div>
              <div className="text-center p-4 rounded-lg bg-muted/20">
                <Target className="h-8 w-8 mx-auto mb-2" />
                <h3 className="font-medium">My Picks</h3>
                <p className="text-sm text-muted-foreground mt-1">Lock in your player prop picks and share with friends</p>
              </div>
            </div>
          </div>
        </TextCard>
          ...
          <div className="space-y-6">
            ...
            <div className="p-6 rounded-lg border-2 border-gray-200">
              ...
              <div className="space-y-3 mb-6">
                ...
                <div className="flex items-center space-x-3">
                  <Check className="h-5 w-5 text-green-600" />
                  <span>My Draft - Basic draft creation</span>
                </div>
                <div className="flex items-center space-x-3">
                  <Check className="h-5 w-5 text-green-600" />
                  <span>My Picks - Create personal lock lists</span>
                </div>
            ...
            {/* Monthly Plan */}
            <div className="p-6 rounded-lg border-2 border-muted bg-muted/10">
              <div className="flex items-center justify-between mb-4">
                <div>
              ...
              <div className="space-y-3 mb-6">
                ...
                <div className="flex items-center space-x-3">
                  <Check className="h-5 w-5 text-green-600" />
                  <span>My Picks - Group lock rooms & performance tracking</span>
                </div>
                <div className="flex items-center space-x-3">
                  <Check className="h-5 w-5 text-green-600" />
            ...
            <div className="p-6 rounded-lg border-2 border-primary bg-primary/5 relative">
              <div className="absolute -top-3 left-1/2 transform -translate-x-1/2">
                <span className="bg-primary text-primary-foreground text-xs px-3 py-1 rounded-full flex items-center">
              ...
              <div className="flex items-center justify-between mb-4">
                <div>
                  ...
                  <p className="text-muted-foreground">Save $15.88 per year</p>
                </div>
                <div className="text-right">
                  <p className="text-3xl font-bold">$20</p>
                  <p className="text-sm text-muted-foreground">per year</p>
                  <p className="text-xs text-muted-foreground">($1.67/month)</p>
                </div>
              </div>
              <div className="space-y-3 mb-6">
                <div className="flex items-center space-x-3">
